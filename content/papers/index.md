...
### [Skill-RAG: Failure-State-Aware Retrieval Augmentation via Hidden-State Probing and Skill Routing](/papers/llm/03-skill-rag-failure-aware-skill-routing-for-rag)

### [R3AG: Retriever Routing for Retrieval-Augmented Generation](/papers/llm/02-r3ag-retriever-routing-for-rag)

### [Route Before Retrieve: Activating Latent Routing Abilities of LLMs for RAG vs. Long-Context Selection](/papers/llm/pre-route-rag-vs-long-context-selection)
